...
rm(list = ls())
# CRAN
packages_from_cran = c('dplyr','reshape2','tibble','ggplot2','ggpubr','openxlsx','vegan','patchwork','tidyr','devtools','BiocManager','agricolae') 
...
if(!requireNamespace("EasyAovWlxPlot", quietly = TRUE))
  install_github("Jayoel/EasyAovWlxPlot")
...
f14_2 <- ggplot(cluster_ITS2,aes(x = '', y = value, fill = Cluster)) + 
  ...
  theme(axis.text = element_blank(),axis.ticks = element_blank(),panel.grid  = element_blank(),
        panel.border = element_blank())
f14_1 / f14_2
detach(package:DirichletMultinomial)
```

...
This part is about ecological deterministic and stochastic processes shape the segment-specific community types.
...
out_bac_DJ <- FEAST(C = L6_bac, 
                    ...
                    outfile = '../Data/04feast2/DJ_bac_source_contributions_matrix.txt')
out_bac_JI <- FEAST(C = L6_bac, 
                    metadata = meta2,
                    different_sources_flag = 1,
                    dir_path = '../Data/04feast2/',
                    outfile = '../Data/04feast2/JI_bac_source_contributions_matrix.txt')
out_bac_IC <- FEAST(C = L6_bac, 
                    metadata = meta3,
                    different_sources_flag = 1,
                    dir_path = '../Data/04feast2/',
                    outfile = '../Data/04feast2/IC_bac_source_contributions_matrix.txt')
out_fun_DJ <- FEAST(C = L6_fun, 
                    metadata = meta1,
                    different_sources_flag = 1,
                    dir_path = '../Data/04feast2/',
                    outfile = '../Data/04feast2/DJ_fun_source_contributions_matrix.txt')
out_fun_JI <- FEAST(C = L6_fun, 
                    metadata = meta2,
                    different_sources_flag = 1,
                    dir_path = '../Data/04feast2/',
                    outfile = '../Data/04feast2/JI_fun_source_contributions_matrix.txt')
out_fun_IC <- FEAST(C = L6_fun, 
                    metadata = meta3,
                    different_sources_flag = 1,
                    dir_path = '../Data/04feast2/',
                    outfile = '../Data/04feast2/IC_fun_source_contributions_matrix.txt')
eff_b1 <- c()
eff_b2 <- c()
eff_b3 <- c()
eff_f1 <- c()
